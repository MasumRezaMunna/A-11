...
export default function AdminTuitionManagement() {
  ...
  if (loading)
    return (
      <div className="p-20 text-center font-bold">Loading Admin Panel...</div>
    );
      ...
      <div className="flex justify-between items-end mb-8">
        <div>
          ...
          <p className="text-slate-500">
            Review, Approve, or Reject tuition requests.
          </p>
        </div>
        ...
        <table className="w-full text-left">
          <thead className="bg-slate-50 border-b border-slate-100">
            <tr>
              ...
              <th className="p-6 font-bold text-slate-400 uppercase text-xs text-right">
                Actions
              </th>
            </tr>
          </thead>
