        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 font-medium max-w-2xl mx-auto">
              We bridge the gap between brilliant tutors and ambitious students
              across Bangladesh with a platform built on trust and efficiency.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-10 bg-slate-50 rounded-[2.5rem] border border-slate-100 hover:shadow-xl transition-all duration-300 group">
              <div className="w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-brand-primary transition-colors">
                <svg
                  className="w-8 h-8 text-brand-primary group-hover:text-white"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p className="text-slate-600 leading-relaxed">
                Every tutor profile is manually screened. We verify educational
                backgrounds from top universities like DIU, BUET, and DU to
            ...
            <div className="p-10 bg-slate-50 rounded-[2.5rem] border border-slate-100 hover:shadow-xl transition-all duration-300 group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Post a job and get applications within minutes. Our smart
                algorithm connects students with tutors who live nearby, saving
            ...
            <div className="p-10 bg-slate-50 rounded-[2.5rem] border border-slate-100 hover:shadow-xl transition-all duration-300 group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Transparency is our core value. Students post jobs for free, and
                tutors only pay a small commission after successfully securing a
                tuition.
              </p>
            </div>
          </div>
